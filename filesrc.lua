...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>mindzhub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "mindzhub", HidePremium = false, IntroText = "mindzhub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("mindzhub SCRIPT")
W:AddLabel("Discordmindzhub")
local Section = W:AddSection({
    Name = "Status"
})
